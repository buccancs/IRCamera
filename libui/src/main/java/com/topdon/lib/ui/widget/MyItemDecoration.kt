...
class MyItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
    /**
     *  RecyclerView ， dp.
     *  item ， [itemLeft] （current）.
     */
    var wholeLeft: Float? = null

    /**
     *  RecyclerView ， dp.
     *  item ， [itemRight] （current）.
     */
    var wholeRight: Float? = null

    /**
     *  RecyclerView ， dp.
     *  item ， [itemTop] （current）.
     */
    var wholeTop: Float? = null

    /**
     *  RecyclerView ， dp.
     *  item ， [itemBottom] （current）.
     */
    ...
    private fun setVerticalMulti(
        ...
        val rowPosition = position / spanCount // current position [0, totalRow)
        val columnPosition = position % spanCount // current position [0, spanCount)
     ...
     * @param itemCount 
     * @param spanCount ()
     * @param spanIndex currentindex[0, spanCount)，
     */
    private fun setVerticalMultiStaggered(
        ...
        val totalRow = itemCount / spanCount + if (itemCount % spanCount == 0) 0 else 1 
        val rowPosition = position / spanCount // currentposition[0, totalRow)
