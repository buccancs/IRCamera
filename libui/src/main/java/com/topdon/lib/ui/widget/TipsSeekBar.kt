...
class TipsSeekBar : ViewGroup, SeekBar.OnSeekBarChangeListener {
    ...
    /**
     * seekBar  onProgressChange event listener.
     */
    var onProgressChangeListener: ((progress: Int, fromUser: Boolean) -> Unit)? = null

    /**
     * seekBar  onStopTrackingTouch event listener.
     */
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) : super(
        ...
        // seekBar  maxHeight  29  xml settings，current View settings maxHeight, attr  seekBar
