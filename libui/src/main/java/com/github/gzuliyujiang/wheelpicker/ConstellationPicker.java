...
@SuppressWarnings("WeakerAccess")
    ...
    public static String JSON = "[{\"id\":0,\"name\":\"[Chinese text]\",\"startDate\":\"\",\"endDate\":\"\",\"english\":\"Unlimited\"},\n" +
            "{\"id\":1,\"name\":\"[Chinese text]\",\"startDate\":\"3-21\",\"endDate\":\"4-19\",\"english\":\"Aries\"},\n" +
            "{\"id\":2,\"name\":\"[Chinese text]\",\"startDate\":\"4-20\",\"endDate\":\"5-20\",\"english\":\"Taurus\"},\n" +
            "{\"id\":3,\"name\":\"[Chinese text]\",\"startDate\":\"5-21\",\"endDate\":\"6-21\",\"english\":\"Gemini\"},\n" +
            "{\"id\":4,\"name\":\"[Chinese text]\",\"startDate\":\"6-22\",\"endDate\":\"7-22\",\"english\":\"Cancer\"},\n" +
            "{\"id\":5,\"name\":\"[Chinese text]\",\"startDate\":\"7-23\",\"endDate\":\"8-22\",\"english\":\"Leo\"},\n" +
            "{\"id\":6,\"name\":\"[Chinese text]\",\"startDate\":\"8-23\",\"endDate\":\"9-22\",\"english\":\"Virgo\"},\n" +
            "{\"id\":7,\"name\":\"[Chinese text]\",\"startDate\":\"9-23\",\"endDate\":\"10-23\",\"english\":\"Libra\"},\n" +
            "{\"id\":8,\"name\":\"[Chinese text]\",\"startDate\":\"10-24\",\"endDate\":\"11-22\",\"english\":\"Scorpio\"},\n" +
            "{\"id\":9,\"name\":\"[Chinese text]\",\"startDate\":\"11-23\",\"endDate\":\"12-21\",\"english\":\"Sagittarius\"},\n" +
            "{\"id\":10,\"name\":\"[Chinese text]\",\"startDate\":\"12-22\",\"endDate\":\"1-19\",\"english\":\"Capricorn\"},\n" +
            "{\"id\":11,\"name\":\"[Chinese text]\",\"startDate\":\"1-20\",\"endDate\":\"2-18\",\"english\":\"Aquarius\"},\n" +
            "{\"id\":12,\"name\":\"[Chinese text]\",\"startDate\":\"2-19\",\"endDate\":\"3-20\",\"english\":\"Pisces\"}]";
    ...
    public void setDefaultValueByDate(Date date) {
        ...
        switch (month) {
            case 1:
                name = day < 21 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 2:
                name = day < 20 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 3:
                name = day < 21 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 4:
                ...
                break;
            case 5:
                name = day < 22 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 6:
                name = day < 22 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 7:
                name = day < 23 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 8:
                name = day < 24 ? "[Chinese text]" : "[Chinese text]";
                break;
            case 9:
                name = day < 24 ? "[Chinese text]" : "[Chinese text]";
                break;
