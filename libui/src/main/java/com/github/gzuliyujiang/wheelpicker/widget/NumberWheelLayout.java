...
public class NumberWheelLayout extends OptionWheelLayout {
    ...
    /**
     * @deprecated [Chinese text] {@link #setRange} [Chinese text]
     */
    @Deprecated
    @Override
    ...
    /**
     * @deprecated [Chinese text] {@link #setOnNumberSelectedListener} [Chinese text]
     */
    @Deprecated
    @Override
    ...
    public void setRange(int min, int max, int step) {
        ...
        // [Chinese text], [Chinese text]OutOfMemory
