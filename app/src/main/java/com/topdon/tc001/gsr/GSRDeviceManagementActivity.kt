...
class GSRDeviceManagementActivity :
        ...
        lifecycleScope.launch {
            try {
                ...
                if (initialized) {
                    ...
                    enableDeviceOperations(
                        BluetoothPermissionUtils.hasBluetoothPermissions(this@GSRDeviceManagementActivity),
                    )
                } else {
    ...
    private fun showPermissionRequiredDialog() {
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage(
                "Bluetooth permissions are required to discover and connect to GSR devices. Please grant the required permissions.",
            )
