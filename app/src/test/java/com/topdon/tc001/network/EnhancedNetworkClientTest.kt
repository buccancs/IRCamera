...
class EnhancedNetworkClientTest {
    ...
    fun testSuccessfulConnection() =
        runTest {
            ...
            every {
                anyConstructed<Socket>().getInputStream()
            } returns ByteArrayInputStream("""{"type":"connection_ack","status":"ok"}""".toByteArray())
    ...
    fun testJsonSerialization() =
        runTest {
            ...
            val sentData = outputStream.toString()
            assertTrue(
                "Should contain all message components",
