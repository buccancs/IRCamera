...
class HubSpokeIntegrationTest {
    ...
    @Test
    fun testCompleteHubSpokeConnectionFlow() =
        runTest {
    ...
    @Test
    fun testCoordinatedSessionManagement() =
        runTest {
            // Connect and setup
    ...
    @Test
    fun testMultiModalSensorCoordination() =
        runTest {
            networkClient.connect(hubHost, hubPort)
            registerAllSensors()
    ...
    @Test
    fun testTimeSynchronizationAccuracy() =
        runTest {
            networkClient.connect(hubHost, hubPort)
    ...
    @Test
    fun testFileTransferCoordination() =
        runTest {
            networkClient.connect(hubHost, hubPort)
            registerAllSensors()
    ...
    @Test
    fun testErrorRecoveryAndReconnection() =
        runTest {
            // Initial connection
            networkClient.connect(hubHost, hubPort)
    ...
    @Test
    fun testConcurrentHubSpokeOperations() =
        runTest {
            networkClient.connect(hubHost, hubPort)
            registerAllSensors()
