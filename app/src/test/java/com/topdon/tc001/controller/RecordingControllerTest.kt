...
class RecordingControllerTest {
    ...
    @Test
    fun testDuplicateSensorRegistration() =
        runTest {
    ...
    @Test
    fun testSensorInitializationFailure() =
        runTest {
    ...
    @Test
    fun testStartRecordingWithoutSensors() =
        runTest {
    ...
    @Test
    fun testStartRecordingWhenAlreadyRecording() =
        runTest {
            registerAllSensors()
    ...
    @Test
    fun testSyncMarkerDistribution() =
        runTest {
            registerAllSensors()
            recordingController.startRecording("TestSession")
    ...
    @Test
    fun testSyncMarkerWhenNotRecording() =
        runTest {
            registerAllSensors()
    ...
    @Test
    fun testRecordingStatsWhenNotRecording() =
        runTest {
            val stats = recordingController.getRecordingStats()
    ...
    @Test
    fun testSensorStatusMonitoring() =
        runTest {
            registerAllSensors()
    ...
    fun testConcurrentOperations() =
        runTest {
            ...
            val recordingStarted =
                operations.filterIndexed { index, _ -> index % 2 == 0 }
