...
async def test_bluetooth_manager():
    ...
    try:
        from ircamera_pc.core.bluetooth_manager import BluetoothManager, BluetoothDeviceType
...
async def test_wifi_manager():
    ...
    try:
        from ircamera_pc.core.wifi_manager import WiFiManager, NetworkSecurityType, HotspotState
        
        # Test basic initialization
        manager = WiFiManager()
        print(f"✅ WiFi Manager initialized")
...
def test_admin_privileges_basic():
    ...
    try:
        from ircamera_pc.core.admin_privileges import PrivilegeLevel, ElevationResult, SystemPermissions
        
        # Test enum values
        levels = [level.value for level in PrivilegeLevel]
        results = [result.value for result in ElevationResult]
        
        print(f"✅ Admin Privileges Enums loaded")
