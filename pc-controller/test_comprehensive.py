...
def test_all_components():
    ...
    try:
        ...
        from ircamera_pc.core import (
            ConfigManager, SessionManager, TimeSyncService,
            GSRIngestor, GSRMode, FileTransferManager, FileType,
            CameraCalibrator, CameraType
        )
        from ircamera_pc.network.server import NetworkServer, DeviceInfo
        ...
        print(f"   ✓ File Transfer Manager: PASS")
        ...
        print(f"   ✓ Camera Calibrator: PASS")
        
        print("\n6. Testing Network Server Integration...")
        network_server = NetworkServer()
        print(f"   ✓ Network server created")
        print(f"   ✓ Ready for device connections")
        
        print("\n7. Testing Time Sync Service...")
        time_sync = TimeSyncService()
        print(f"   ✓ Time sync service created")
        ...
        print(f"   ✓ Calibration sessions: {len(camera_calibrator.get_active_calibrations())} active")
