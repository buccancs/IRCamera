...
def main():
    ...
    try:
        ...
        print("* Message Creation: OK Working")
        print("* Network Server: OK Updated for protocol")
        print("* PyQt6 Compatibility: OK Imports updated")
        print("* Package Versions: OK Updated to latest")
