...
class SessionManager:
    ...
    def end_session(self) -> SessionMetadata:
        ...
        if self._current_session.started_at:
            start_time = datetime.fromisoformat(self._current_session.started_at.replace('Z', '+00:00'))
        ...
        logger.info(f"Session ended: {self._current_session.name} "
    ...
    def _save_metadata(self) -> None:
        ...
        metadata_file = self._get_session_directory(self._current_session.session_id) / "metadata.json"
