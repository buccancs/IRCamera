...
class FileTransferManager:
    ...
    async def _execute_transfer(self, job: TransferJob):
        ...
        try:
            ...
            logger.info(f"Size: {job.manifest.size_bytes} bytes, Duration: {duration:.2f}s, Rate: {rate/1024/1024:.2f} MB/s")
        ...
        try:
            ...
            with open(job.local_path, mode) as f:
                ...
                while bytes_remaining > 0:
                    ...
                    chunk_data = await self._read_chunk_from_device(job, bytes_transferred, chunk_size)
