...
class ConnectionImpl implements Connection, ScanListener {
 ...
 private GenericRequest currentRequest;//Current
 private final EventObserver observer;//
 private boolean isReleased;//ConnectionWhether
 private final Handler connHandler;//ConnectionHandler，
 private long connStartTime; //Connection
 private int refreshCount;//（），
 private int tryReconnectCount;//
 private ConnectionState lastConnectionState;//ConnectionStatus
 private int reconnectImmediatelyCount = 0; //
 private boolean refreshing;//Whether
 private boolean isActiveDisconnect;//WhetherDisconnectConnection
 ...
 connHandler.sendEmptyMessageDelayed(MSG_CONNECT, connectDelay); //Connection
 ...
 */
 ...
 case MSG_ON_CONNECTION_STATE_CHANGE://ConnectionStatus
 ...
 easyBle.releaseConnection(device);//Delete
 }
 }
