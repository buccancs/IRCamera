...
class ConnectionImpl implements Connection, ScanListener {
    ...
    private final List<GenericRequest> requestQueue = new ArrayList<>();//Queue
    ...
    private ConnectionState lastConnectionState;//State
        ...
        public void handleMessage(Message msg) {
            ...
            if (connection != null) {
                ...
                switch (msg.what) {
                    ...
                    case MSG_ON_CONNECTION_STATE_CHANGE://State
