...
public class ConnectionConfiguration {
    ...
    public ConnectionConfiguration setTryReconnectMaxTimes(int tryReconnectMaxTimes) {
        ...
        /**
     * [Chinese text], [Chinese text]MAC[Chinese text], [Chinese text], [Chinese text]
     */
     ...
     * [Chinese text]mode
     *
     * @param transport {@link BluetoothDevice#TRANSPORT_AUTO}[Chinese text]in progress[Chinese text]
     */
    @RequiresApi(Build.VERSION_CODES.M)
    ...
    public ConnectionConfiguration setPhy(int phy) {
        ...
        /**
     * [Chinese text], [Chinese text], first: [Chinese text], second: [Chinese text], [Chinese text]. [Chinese text]1[Chinese text], [Chinese text]2[Chinese text], [Chinese text]5[Chinese text], [Chinese text]30[Chinese text]
     */
