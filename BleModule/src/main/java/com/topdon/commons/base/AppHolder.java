...
public class AppHolder implements Application.ActivityLifecycleCallbacks {
    ...
    public static void initialize(@NonNull Application application) {
        ...
        //[Chinese text]Application, [Chinese text]listener
     ...
     * finish[Chinese text]Activity
     *
     * @param classNames [Chinese text]Activity[Chinese text], [Chinese text]null[Chinese text]finish[Chinese text]Activity
     */
    ...
    /**
     * finish[Chinese text]Activity[Chinese text]
     */
