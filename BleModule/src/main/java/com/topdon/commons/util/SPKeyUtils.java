...
public class SPKeyUtils {
    ...
    /**
     * ad900
     * [Chinese text]usb copy
     */
    public static final String LOAD_USB_COPY = "load_usb_copy";//

    /**
     * ad900
     * [Chinese text]copy[Chinese text]
     */
    public static final String COPY_SUCCESS = "copy_success";// [Chinese text]copy[Chinese text]

    /**
     * keynow
     * [Chinese text]message/information
     */
