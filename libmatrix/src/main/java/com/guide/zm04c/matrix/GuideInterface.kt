...
class GuideInterface {
 ...
 private val TEMP_MATRIX_SIZE = IR_SIZE * 4 // 196608 4byte = 1Temperature
 ...
 */
 ...
 mNativeGuideCore!!.toFloatTempMatrix(mTempMatrixFloat, mTempMatrixByte) // Temperature
// if (startTime == 0L) {
...
// }
 ...
 mIrDataCallback!!.processIrData(mYuv, mTempMatrixFloat) // Temperature
 }
 } else {
