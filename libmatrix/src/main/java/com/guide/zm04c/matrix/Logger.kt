...
object Logger {
    ...
    private val MYLOG_PATH_SDCARD_DIR = "/sdcard/Guide/log" // [Chinese text]sdcardin progress[Chinese text]

    private val MYLOGFILEName = "Log.txt" // [Chinese text]

    private val myLogSdf = SimpleDateFormat("yyyy-MM-dd HH:mm:ss") // [Chinese text]

    private val logfile = SimpleDateFormat("yyyy-MM-dd") // [Chinese text]
     ...
     * @param text
     */
    fun f(tag: String, text: String) { // [Chinese text]
        val nowtime = Date()
        ...
        try {
            val filerWriter = FileWriter(file, true) // [Chinese text]in progress[Chinese text], [Chinese text]
