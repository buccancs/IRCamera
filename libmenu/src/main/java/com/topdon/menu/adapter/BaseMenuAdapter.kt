...
/**
 * [Chinese text]Pseudo color[Chinese text], [Chinese text]menu Adapter [Chinese text].
 *
...
internal abstract class BaseMenuAdapter : RecyclerView.Adapter<BaseMenuAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val iconSize: Int = (widthPixels * 62 / 375f).toInt() // 62, 375 [Chinese text] UI [Chinese text]
        ...
        if (itemCount <= 4) {
            ...
            val bigMargin: Int = (widthPixels * 24 / 375f).toInt()  // [Chinese text] UI [Chinese text] 24
            val smallMargin: Int = (widthPixels * 8 / 375f).toInt() // [Chinese text] UI [Chinese text] item [Chinese text] 16
            when (viewType) {
