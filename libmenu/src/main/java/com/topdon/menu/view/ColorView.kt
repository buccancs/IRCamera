...
class ColorView : View {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val barHeight: Int = (width * 73f / 62).toInt() //6273UI 62:73
        val triangleSize: Int = (width * 12f / 62).toInt() //6212UI 12，62
        val margin: Int = SizeUtils.dp2px(4f) // 4dp
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isSelected) {
            ...
            val normalBarWidth: Int = (width * 50f / 62).toInt() //50，62
            val normalBarHeight: Int = (normalBarWidth * 60f / 50).toInt() // 50:60
