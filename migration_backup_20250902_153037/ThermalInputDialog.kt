...
class ThermalInputDialog : Dialog {
    ...
    private var action = 100 // 100:[Chinese text]temperature[Chinese text]     201: temperature[Chinese text]   301: temperature[Chinese text]
    ...
    class Builder {
        ...
        private var upColor = Color.parseColor("#FFF3812F") //[Chinese text]
        private var downColor = Color.parseColor("#FF28C445") //[Chinese text]
        private var selectColor = 0//[Chinese text]
        private var max = 0f
        private var min = 0f
