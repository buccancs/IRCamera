...
class MoreFragment : BaseFragment(), View.OnClickListener {
    ...
    override fun initView() {
        ...
        setting_item_model.setOnClickListener(this)//temperature[Chinese text]
        setting_item_correction.setOnClickListener(this)//[Chinese text]
        setting_item_dual.setOnClickListener(this)//dual light[Chinese text]
        setting_item_unit.setOnClickListener(this)//temperature[Chinese text]
        setting_version.setOnClickListener(this) //TC007[Chinese text]
        setting_device_information.setOnClickListener(this)//TC007[Chinese text]
        setting_reset.setOnClickListener(this)//TC007[Chinese text]settings
    ...
    override fun onClick(v: View?) {
       when(v){
           setting_item_model -> {//temperature[Chinese text]
           ...
           setting_item_correction->{//[Chinese text]
           ...
           setting_version -> {//TC007[Chinese text]
...
//               }
           ...
           setting_device_information -> {//TC007[Chinese text]
           ...
           setting_reset -> {//TC007[Chinese text]settings
               if (WebSocketProxy.getInstance().isTC007Connect()) {
                   restoreFactory()
               }
           }
