...
@Deprecated("[Chinese text]highlow[Chinese text]menu, [Chinese text]")
class MenuAIAdapter (val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    /**
     * [Chinese text]mode-menu2-highlow[Chinese text] point[Chinese text]eventlistener, [Chinese text]. 
     */
