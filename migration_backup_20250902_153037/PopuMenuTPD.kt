...
//
//
////[Chinese text][temperaturemeasurement][Chinese text]
...
//        popupWindow.setBackgroundDrawable(ColorDrawable(0x00000000)) // [Chinese text] 7.0 [Chinese text], point[Chinese text]
