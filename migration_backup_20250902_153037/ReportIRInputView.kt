    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        when (type) {
            TYPE_FULL -> {
                ...
                cl_max.tv_item_name.text = context.getString(
                    R.string.chart_temperature_high,
                ) + " (${UnitTools.showUnit()})"
                cl_min.tv_item_name.text = context.getString(
            ...
            TYPE_POINT -> {
                ...
                cl_average.isVisible = false
                cl_max.tv_item_name.text = "P${index + 1} " +
                    context.getString(
                        R.string.chart_temperature,
                    ) + " (${UnitTools.showUnit()})"
            ...
            TYPE_LINE -> {
                ...
                cl_max.tv_item_name.text = "L${index + 1} " +
                    context.getString(
                        R.string.chart_temperature_high,
                    ) + " (${UnitTools.showUnit()})"
                cl_min.tv_item_name.text = "L${index + 1} " +
                    context.getString(
                        R.string.chart_temperature_low,
                    ) + " (${UnitTools.showUnit()})"
                cl_average.tv_item_name.text = "L${index + 1} " +
                    context.getString(
                        R.string.album_report_mean_temperature,
                    ) + " (${UnitTools.showUnit()})"
            ...
            TYPE_RECT -> {
                ...
                cl_min.isVisible = true
                cl_average.isVisible = true
                cl_max.tv_item_name.text = "R${index + 1} " +
                    context.getString(
                        R.string.chart_temperature_high,
                    ) + " (${UnitTools.showUnit()})"
                cl_min.tv_item_name.text = "R${index + 1} " +
                    context.getString(
                        R.string.chart_temperature_low,
                    ) + " (${UnitTools.showUnit()})"
                cl_average.tv_item_name.text = "R${index + 1} " +
                    context.getString(
                        R.string.album_report_mean_temperature,
                    ) + " (${UnitTools.showUnit()})"
