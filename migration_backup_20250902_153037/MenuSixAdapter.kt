...
class MenuSixAdapter (val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private var rangeEnable = false //[Chinese text]
    private var pseudoMode = MenuBean.TYPE_MIX//[Chinese text]mode
    private var lightLevel = MenuBean.TYPE_LIGHT_MIDDLE//[Chinese text]: high
    private var pipEnable = false //[Chinese text]in progress[Chinese text]
    private var gainLevel = MenuBean.TYPE_GAIN_X1//[Chinese text]
    ...
    inner class ItemView(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            if (ScreenUtil.isPortrait(context)) {
                ...
                val count = 3.5 //[Chinese text]4[Chinese text]
