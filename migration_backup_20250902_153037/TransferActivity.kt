...
/**
 * [Chinese text], [Chinese text] TC001 APP [Chinese text], [Chinese text] APP [Chinese text].
 *
...
class TransferActivity : BaseActivity() {
    ...
    /**
     * [Chinese text] Intent in progress[Chinese text] Uri [Chinese text] ir [Chinese text].
     */
    ...
    /**
     * [Chinese text]gallery[Chinese text]gallery.
     */
