...
class DirDetect() : DirBase() {
    ...
    /**
     * [Chinese text] id [Chinese text] 0, [Chinese text] (1), position + 1, itemList [Chinese text], [Chinese text].
     */
    ...
    /**
     * [Chinese text], [Chinese text] id, parent [Chinese text] 0, [Chinese text].
     */
