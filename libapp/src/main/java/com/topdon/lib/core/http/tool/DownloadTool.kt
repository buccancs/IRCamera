...
object DownloadTool {
 ...
 .retryOnConnectionFailure(false) // Retry
 .connectTimeout(10, TimeUnit.SECONDS) // 10DefaultValue
 .readTimeout(10, TimeUnit.SECONDS) // 10DefaultValue
 .writeTimeout(10, TimeUnit.SECONDS) // 10DefaultValue
 .build()
