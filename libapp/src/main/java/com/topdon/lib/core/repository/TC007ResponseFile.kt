...
data class Param(
 var brightness: Int = 50, // , 0-100, Default50
 var contrast: Int = 50, // , 0-100, Default50
 var saturation: Int = 50, // , 0-100, Default50
 var sharpness: Int = 50, // , 0-100, Default50
 var flipMode: Int = 0, // , 0:, 1: 2: 3:180
)
...
data class IsothermC(
 val mode: Int, // 0：，1：Value，2：Value，3：
