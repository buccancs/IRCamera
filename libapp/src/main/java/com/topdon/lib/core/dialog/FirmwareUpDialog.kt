...
import com.topdon.libapp.databinding.DialogFirmwareUpBinding
...
class FirmwareUpDialog(context: Context) : Dialog(context, R.style.InfoDialog), View.OnClickListener {
    ...
    private val binding: DialogFirmwareUpBinding = DialogFirmwareUpBinding.inflate(LayoutInflater.from(context))
