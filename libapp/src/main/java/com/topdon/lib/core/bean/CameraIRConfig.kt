 ...
 * @param isOpen 
 * @param continuaTime continuouscapture，
...
data class CameraItemBean(
    ...
    companion object {
        ...
        const val DELAY_TIME_0 = 0 // delayed3
        const val DELAY_TIME_3 = 3 // delayed3
        const val DELAY_TIME_6 = 6 // delayed6

        // 
        const val TYPE_TMP_ZD = -1 // 
        const val TYPE_TMP_C = 1 // normal temperature
