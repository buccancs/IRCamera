                        ...
                        override fun migrate(database: SupportSQLiteDatabase) {
                            ...
                            database.execSQL(
                                ...
                                CREATE TABLE IF NOT EXISTS `thermal` (
                                    ...
                                    `thermal_id` TEXT NOT NULL,
                                    `user_id` TEXT NOT NULL,
                                    `thermal` REAL NOT NULL,
                                    `thermal_max` REAL NOT NULL,
                                    `thermal_min` REAL NOT NULL,
                                    `sn` TEXT NOT NULL,
                                    `info` TEXT NOT NULL,
                                    `type` TEXT NOT NULL,
                            ...
                            database.execSQL(
                                """
                                CREATE TABLE IF NOT EXISTS `HouseDetect` (
                                    `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                                    `name` TEXT NOT NULL,
                                    ...
                                    `year` INTEGER,
                                    `houseSpace` TEXT NOT NULL,
                                    `houseSpaceUnit` INTEGER NOT NULL,
                                    `cost` TEXT NOT NULL,
                                    `costUnit` INTEGER NOT NULL,
                                    `detectTime` INTEGER NOT NULL,
                            ...
                            database.execSQL(
                                ...
                                CREATE TABLE IF NOT EXISTS `HouseReport` (
                                    ...
                                    `createTime` INTEGER NOT NULL,
                                    `updateTime` INTEGER NOT NULL,
                                    `inspectorWhitePath` TEXT NOT NULL,
                                    `inspectorBlackPath` TEXT NOT NULL,
                                    `houseOwnerWhitePath` TEXT NOT NULL,
                                    `houseOwnerBlackPath` TEXT NOT NULL
                                )
                                """.trimIndent()
                            )
                            ...
                            database.execSQL(
                                """
                                CREATE TABLE IF NOT EXISTS `DirDetect` (
                                    ...
                                    `dangerCount` INTEGER NOT NULL,
                                    FOREIGN KEY (`parentId`) REFERENCES `HouseDetect` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
                                )
                                """.trimIndent()
                            )
                ...
                .addMigrations(
                    object : Migration(5, 6) {
                        override fun migrate(database: SupportSQLiteDatabase) {
                            ...
                            database.execSQL(
                                """
                                CREATE TABLE IF NOT EXISTS `thermal_minute` (
                                    `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                                    `thermal_id` TEXT NOT NULL,
                                    `user_id` TEXT NOT NULL,
                                    `thermal` REAL NOT NULL,
                            ...
                            database.execSQL(
                                """
                                CREATE TABLE IF NOT EXISTS `thermal_hour` (
                                    `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                                    `thermal_id` TEXT NOT NULL,
                                    `user_id` TEXT NOT NULL,
                                    `thermal` REAL NOT NULL,
                            ...
                            database.execSQL(
                                """
                                CREATE TABLE IF NOT EXISTS `thermal_day` (
                                    `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                                    `thermal_id` TEXT NOT NULL,
                                    `user_id` TEXT NOT NULL,
                                    `thermal` REAL NOT NULL,
