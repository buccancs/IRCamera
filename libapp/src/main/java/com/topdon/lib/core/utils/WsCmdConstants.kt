...
object WsCmdConstants {
    ...
    const val AR_COMMAND_VERSION_GET = 3 // [Chinese text]
    const val AR_COMMAND_DEV_INFO_GET: String = "AR_COMMAND_DEV_INFO_GET" // [Chinese text]message
    const val AR_COMMAND_CONFIG_RESET: String = "AR_COMMAND_CONFIG_RESET"
    const val AR_COMMAND_ALL_RESET: String = "AR_COMMAND_ALL_RESET" // [Chinese text]
    const val AR_COMMAND_POWER_CTL: String = "AR_COMMAND_POWER_CTL" // [Chinese text], [Chinese text]
    const val AR_COMMAND_BATTERY_GET: String = "AR_COMMAND_BATTERY_GET" // [Chinese text]message
    const val AR_COMMAND_USBPC_CONN_STATE_GET: String = "AR_COMMAND_USBPC_CONN_STATE_GET"
    const val AR_COMMAND_LANGUAGE_SET: Int = 11 // [Chinese text]
    const val AR_COMMAND_LANGUAGE_GET: String = "AR_COMMAND_LANGUAGE_GET"
    const val AR_COMMAND_DATETIME_SET: String = "AR_COMMAND_DATETIME_SET" // [Chinese text]
    const val AR_COMMAND_DATETIME_GET: String = "AR_COMMAND_DATETIME_GET"
    const val AR_COMMAND_TIMEZONE_SET: String = "AR_COMMAND_TIMEZONE_SET" // [Chinese text]
    const val AR_COMMAND_TIMEZONE_GET: String = "AR_COMMAND_TIMEZONE_GET"
    const val AR_COMMAND_WIFI_AP_ONOFF_SET: String = "AR_COMMAND_WIFI_AP_ONOFF_SET" // [Chinese text]point[Chinese text]
    const val AR_COMMAND_WIFI_AP_ONOFF_GET: String = "AR_COMMAND_WIFI_AP_ONOFF_GET"
    const val AR_COMMAND_WIFI_AP_CONFIG_SET: String = "AR_COMMAND_WIFI_AP_CONFIG_SET" // [Chinese text]point[Chinese text]
    ...
    const val AR_COMMAND_STORAGE_FORMAT: String = "AR_COMMAND_STORAGE_FORMAT" // [Chinese text]
    const val AR_COMMAND_STORAGE_DELETE_FILE: String = "AR_COMMAND_STORAGE_DELETE_FILE" // [Chinese text]
    const val AR_COMMAND_STORAGE_GET_FILELIST: String = "AR_COMMAND_STORAGE_GET_FILELIST" // [Chinese text]
    const val AR_COMMAND_STORAGE_GET_FILECNT: String = "AR_COMMAND_STORAGE_GET_FILECNT"
    const val AR_COMMAND_STORAGE_GET_SPACEINFO: String = "AR_COMMAND_STORAGE_GET_SPACEINFO" // [Chinese text]message
    const val AR_COMMAND_SET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_SET_KEY_CAPTURE_FUNC" // Photo capture[Chinese text]
    const val AR_COMMAND_GET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_GET_KEY_CAPTURE_FUNC"
    const val AR_COMMAND_SET_CONTINUOUS_SHOOTING: String = "AR_COMMAND_SET_CONTINUOUS_SHOOTING" // Settings[Chinese text]Photo capture
    const val AR_COMMAND_RETICLE_SET: Int = 101 // [Chinese text]
    const val AR_COMMAND_RETICLE_GET: String = "AR_COMMAND_RETICLE_GET"
    const val AR_COMMAND_SNAPSHOT: Int = 103 // Photo capture
    const val AR_COMMAND_VRECORD: Int = 104 // recordingstart[Chinese text]
    const val AR_COMMAND_RECORD_STATUS_GET: String = "AR_COMMAND_RECORD_STATUS_GET" // [Chinese text]recording[Chinese text]
    const val AR_COMMAND_LASER_SET: String = "AR_COMMAND_LASER_SET"
    const val AR_COMMAND_LASER_GET: String = "AR_COMMAND_LASER_GET"
    const val AR_COMMAND_PIP_SET: String = "AR_COMMAND_PIP_SET" // [Chinese text]in progress[Chinese text]
    const val AR_COMMAND_PIP_GET: Int = 108 // [Chinese text]in progress[Chinese text]
    const val AR_COMMAND_ZOOM_SET: String = "AR_COMMAND_ZOOM_SET" // [Chinese text]
    const val AR_COMMAND_ZOOM_GET: Int = 110 // [Chinese text]
    ...
    const val AR_COMMAND_PSEUDO_COLOR_GET: Int = 209 // [Chinese text]Pseudo color[Chinese text]
    ...
    const val AR_COMMAND_FREEZE_SET: String = "AR_COMMAND_FREEZE_SET" // [Chinese text]
    const val AR_COMMAND_TISR_SET: String = "AR_COMMAND_TISR_SET" // [Chinese text]
    const val AR_COMMAND_TISR_GET: Int = 214
    const val AR_COMMAND_RANGE_FIND_SET: String = "AR_COMMAND_RANGE_FIND_SET" // [Chinese text]
    ...
    const val AR_COMMAND_PANEL_PARAM_SET: String = "AR_COMMAND_PANEL_PARAM_SET" // [Chinese text]
    ...
    const val APP_EVENT_HEART_BEATS: Int = 1001 // [Chinese text]
    const val APP_EVENT_DISTANCE_DATA: Int = 500 // [Chinese text]
    const val APP_EVENT_TEMP_DATA: Int = 500 // temperature[Chinese text]
}
