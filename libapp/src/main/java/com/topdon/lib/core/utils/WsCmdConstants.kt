...
object WsCmdConstants {
    ...
    const val AR_COMMAND_DEV_INFO_GET: String = "AR_COMMAND_DEV_INFO_GET" // 设备message
    ...
    const val AR_COMMAND_BATTERY_GET: String = "AR_COMMAND_BATTERY_GET" // 获取电池message
    ...
    const val AR_COMMAND_STORAGE_GET_SPACEINFO: String = "AR_COMMAND_STORAGE_GET_SPACEINFO" // 获取存储空间message
    const val AR_COMMAND_SET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_SET_KEY_CAPTURE_FUNC" // Photo capture键长按功能
    const val AR_COMMAND_GET_KEY_CAPTURE_FUNC: String = "AR_COMMAND_GET_KEY_CAPTURE_FUNC"
    const val AR_COMMAND_SET_CONTINUOUS_SHOOTING: String = "AR_COMMAND_SET_CONTINUOUS_SHOOTING" // Settings连续Photo capture
