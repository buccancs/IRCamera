...
public class EasyWifi {
 ...
 if (addNetwork == -1) {
 Log.e(this.TAG, "Failed,wifilistCancelConnectionsaved");
 }
 ...
 if (isExist != null) {
 Log.d(this.TAG, "createWifiConfig: （true:Success，false:Failed），=" + this.wifiManager.removeNetwork(isExist.networkId) + "saved" + this.wifiManager.saveConfiguration());
 }
