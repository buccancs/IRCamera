...
/**
 * 当前类封装不受“Save settings开关”影响的配置项，
 *
 * [SaveSettingUtil] 保存受“Save settings开关”影响的配置项.
 *
...
object SharedManager {
    ...
    private const val VERSION_CHECK_DATE = "version_check_date"//版本检测的Date
