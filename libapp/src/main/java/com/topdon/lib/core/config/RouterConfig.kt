...
object RouterConfig {
    ...
    const val THERMAL_LOG = "/$GROUP_IR/thermal/log"
    const val THERMAL_LOG_CHART = "/$GROUP_IR/thermal/log/chart"
    const val THERMAL_LOG_SINGLE_CHART = "/$GROUP_IR/thermal/log/single/chart"
    const val CHART = "/$GROUP_IR/chart"
    const val VIDEO = "/$GROUP_IR/video"
