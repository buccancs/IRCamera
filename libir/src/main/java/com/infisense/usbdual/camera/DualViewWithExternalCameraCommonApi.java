...
public class DualViewWithExternalCameraCommonApi extends BaseDualView {
    ...
    public DualViewWithExternalCameraCommonApi(SurfaceView cameraview, UVCCamera irUVCCamera,
        ...
        iFrameCallback = new IFrameCallback() {
             ...
             * mixData ARGBdualwidth * dualHeight * 4
             * irData Y16irWidth * irHeight * 2
             * tempData Y16irWidth * irHeight * 2
             * remapTempData  YUV422 dualwidth * dualHeight * 2
             * vlData  RGB24 vlWidth * vlHeight * 3
             * vlARGBData  dualwidth * dualHeight * 4
             * ScreenFusion:mixData ARGBdualwidth * dualHeight * 4
...
//                }
    ...
    public void startPreview() {
         ...
         * setIrFrameCallback
         * setFusion(HSLFusion), setIsothermal,setPseudocolor, setCustomPseudocolor
