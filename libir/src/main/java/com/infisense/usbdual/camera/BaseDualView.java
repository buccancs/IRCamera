...
public abstract class BaseDualView {
 ...
 protected byte[] remapTempData;//Temperature
 protected byte[] mixData;//fusion
 protected byte[] normalTempData;//Temperature
 protected byte[] mixDataRotate;
 protected byte[] irData;//infrared
 public byte[] vlData;//visible light
