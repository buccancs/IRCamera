...
/**
 * TC007、2D、 point/line/area View、SurfaceView ，
 *  draw ，。
 *
...
class TempDrawHelper {
    ...
    /**
     * 、、 AB 、point/line/area Paint，
     * color， 14sp，color、settings.
     */
