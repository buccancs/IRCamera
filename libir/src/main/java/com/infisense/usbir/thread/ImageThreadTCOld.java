...
////                    ImageTools.INSTANCE.readFrame(imageDst, temperatureSrc, max, min,maxColor,minColor);//color
//                    BitmapTools.INSTANCE.replaceBitmapColor(imageDst, temperatureSrc, max, min,0,0);//color
//                }
//                Log.w(":", imageDst.toString());
//            }
//            synchronized (syncImage.viewLock) {
//                if (!syncImage.valid) {
//                    if (bitmap != null) {
//                        bitmap.copyPixelsFromBuffer(ByteBuffer.wrap(imageDst)); //bitmaprefresh
//                    } else {
...
//            } catch (Exception e) {
//                XLog.e("Image Threadrefresh: " + e.getMessage());
//            }
//        }
