    ...
    override fun initView() {
        ...
        lifecycleScope.launch {
            withContext(Dispatchers.IO){
                ...
                System.arraycopy(allBytes, imageBytes.size+headLen, temperatureBytes, 0, temperatureBytes.size) // temperature[Chinese text] (192 x 256 x 2)
            }
