...
\1set.setCircleColor(ContextCompat.getColor(this, R.color.white))//(hideprocessing)
 set.fillAlpha = 200
 ...
 Log.w(
 "123",
 ":${(data.last().createTime - data.first().createTime) / 1000}",
 )
 ...
 chart.zoom(1f, 1f, chart.xChartMax, 0f) // Default，
 }
