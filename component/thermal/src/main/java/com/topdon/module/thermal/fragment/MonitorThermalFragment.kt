...
\1ToastUtils.showShort("Test Data")
            Log.w("123", "Test Data")
...
//    }
    ...
    fun action(event: ThermalActionEvent) {
        Log.w("123", "event:${event.action}"Test Data"Text"Test Data"Text"Test Data"Text")
            return
        }
    ...
    private fun addFence() {
        showFence(3)
        type = "fence"Test Data"123", "Test Data")
            return
        }
