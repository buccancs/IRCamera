...
class MonitorChartActivity : BaseActivity(), View.OnClickListener, OnChartValueSelectedListener {
 ...
 private var latestTime = 0L // Current,Whether(, , )
...
\1
 ...
 e.printStackTrace()
 Log.e(TAG, "Temperature:${e.message}")
 }
 }
...
\1ToastUtils.showShort("enabledfailed")
 Log.w("123", "Failed")
 ...
 */
 ...
 xAxis.isGranularityEnabled = true // Value
 xAxis.textSize = 9f
\1xAxis.setLabelCount(6, true)//true
 ...
 startTime = System.currentTimeMillis()
 canUpdate = true // Start
 }

 /**
\1processingupdatedata
 */
 ...
 */
 ...
 Log.w("123", "SettingsstartTime:$startTime")
...
\1set.fillDrawable = fillColor//set
 ...
 set.setDrawValues(false) // SettingsWhetherValue
...
\1,CurrentEnd，DeleteCurrentdata
