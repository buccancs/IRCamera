...
class MonitorChartActivity : BaseActivity(), View.OnClickListener, OnChartValueSelectedListener {
    ...
    private fun initRecycler() {
        ...
        // SettingsactivityType(activity activity activity activity)
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                while (isRecord) {
                    if (canUpdate) {
                        ...
                        Log.w("123", "Currentactivity")
                    }
                }
                Log.w("123", "activity, activity:$time")
            }
    }
...
//        set.fillDrawable = fillColor//Settingsactivity
