...
\12024-5-30 09:16 TS004APP，3.30hide
 settingVersion.isVisible = false
 }
 ...
 */
 ...
 if (isSuccess) {
 XLog.d("TS004 - TS004 Success，DisconnectConnection")
 ...
 XLog.i("Settings ${if (isSuccess) "Success" else "Failed"}")
 if (isSuccess) {
