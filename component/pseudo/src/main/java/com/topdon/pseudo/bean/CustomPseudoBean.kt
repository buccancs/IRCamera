...
data class CustomPseudoBean(
 var selectIndex: Int = 0, // Current index
 var colors: IntArray? = null, // 7 Value
 var zAltitudes: IntArray? = null, // 7 
 var places: FloatArray? = null, // 7 Value
 var isUseCustomPseudo: Boolean = false, // true- false-
 var maxTemp: Float = 50f, // Temp，Unit，Default50
 var minTemp: Float = 0f, // Temp，Unit，Default0
 var isColorCustom: Boolean = true, // true- false-
 var customMinColor: Int = 0xff0000FF.toInt(), // Value(Temp)
 var customMiddleColor: Int = 0xFFFF0000.toInt(), // Value
 var customMaxColor: Int = 0xFFFFFF00.toInt(), // Value(Temp)
