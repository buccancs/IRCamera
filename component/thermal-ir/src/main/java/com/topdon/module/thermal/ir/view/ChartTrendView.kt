...
class ChartTrendView : LineChart {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        val textColor: Int = ContextCompat.getColor(context, LibAppR.color.chart_text)
        val axisChartColors: Int = ContextCompat.getColor(context, LibAppR.color.chart_axis)
