...
class ChartTrendView : LineChart {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        ...
        this.isScaleXEnabled = false // [Chinese text]X[Chinese text]
        ...
        this.axisRight.isEnabled = false // [Chinese text]right sideY[Chinese text]
        ...
        legend.isEnabled = false// [Chinese text]line[Chinese text]
    ...
    fun refresh(tempList: List<Float>) {
        ...
        lineDataSet.color = 0xffffffff.toInt()// [Chinese text]line[Chinese text]
        lineDataSet.circleHoleColor = 0xffffffff.toInt()// [Chinese text]
        lineDataSet.setCircleColor(0xffffffff.toInt())// [Chinese text]
        lineDataSet.valueTextColor = Color.WHITE
        lineDataSet.lineWidth = 2f
        lineDataSet.circleRadius = 1f// [Chinese text]point[Chinese text]
        lineDataSet.fillAlpha = 200
        lineDataSet.valueTextSize = 10f
        lineDataSet.setDrawValues(false)// Settings[Chinese text]
