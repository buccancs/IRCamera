...
class IREmissivityActivity : BaseActivity() {
    ...
    private class MyOnScrollListener(val titleView: View, val layoutManager: LinearLayoutManager, val dataArray: Array<ItemBean>) : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (dataArray[seeFirstPosition].isTitle) {// [Chinese text], [Chinese text]
                currentPosition = seeFirstPosition
                tvTitle.text = dataArray[currentPosition].name
                titleView.translationY = 0f
            } else {
                // [Chinese text]visiblerange[Chinese text]
                ...
                if (nextTitlePosition < 0) {
                    // [Chinese text], dataArray[seeFirstPosition].isTitle == true [Chinese text], [Chinese text]
        ...
        /**
         * [Chinese text] position [Chinese text], [Chinese text] position [Chinese text] title position.
         */
    ...
    private class MyAdapter(val context: Context, val dataArray: Array<ItemBean>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            return if (viewType == 0) {// [Chinese text]
    ...
    /**
     * [Chinese text]
     * @param isTitle true-[Chinese text] false-[Chinese text]
     * @param name [Chinese text], [Chinese text], [Chinese text]
     * @param minTemp [Chinese text]lowtemperature, [Chinese text]
     * @param maxTemp [Chinese text]hightemperature, [Chinese text]
     * @param emStr [Chinese text]text
     */
