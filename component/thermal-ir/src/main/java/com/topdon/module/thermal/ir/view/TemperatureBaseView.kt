 ...
 */
 ...
 /**
\1， Touch Down Value，，Unit px.
 */
 private val TOUCH_TOLERANCE = SizeUtils.dp2px(8f)

 /**
\1Delete， Touch UP Touch Down Value，Delete，Unit px.
 */
 ...
 */
 ...
 /**
\1CurrentWhetherdisplayfull image.
 */
 @Volatile
 ...
 */
 ...
 /**
\1 View ，Connection (startX, startY)、(stopX, stopY) drawing.
 */
 protected fun drawLine(
 canvas: Canvas,
 line: Line,
 ) {
\1drawing，Current View ，temperature(192x256)conversion View 
 ...
 *
\1， x、y processing，drawing。
\1@param isMax true-high temperature false-low temperature
 */
...
\1drawing，Current View ，temperature(192x256)
\1Current，conversiontemperature，
 ...
 */
 ...
 /**
\1，save DOWN Status，calculation.
 */
