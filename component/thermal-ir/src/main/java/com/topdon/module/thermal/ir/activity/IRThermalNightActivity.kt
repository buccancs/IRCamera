 ...
 *
\1，，SDK data，
\1dataMode， image+temperature dataMode。
 */
...
\1 ircmd Whetherinitialize， ircmd initializeset false ，
...
\1
 ...
 /**
\1-fusion、set-、set-、-Mode、-
\1PopupWindow，.
 */
 private var popupWindow: PopupWindow? = null

 /**
\1 TS001 ，CurrentWhethertemperature measurementMode.
\1true-temperature measurementMode false-Mode
 */
 private var isTs001TempMode = true

\1Currenttab position，Default1
 protected var curChooseTabPos = 1

\1Default1-Mode 2-Type
 private var curTargetStyle = 1

 /**
\1Whethertemperature measurement-high temperature、low temperature，low temperaturedialogdisplayhide
 */
 @Volatile
...
\1renderingMode
 ...
 Log.e("TemperatureFailed", e.message.toString())
 }
 try {
...
\1font colorWhethersave
 ...
 /**
\1 TS001 ， temperature measurement/ Mode.
\1@param isToTemp true-temperature measurement false-
 */
...
\1disabled AI (、high temperature、low temperature)
...
\1pseudo-color bardisplayStatus
...
\1high temperature、low temperature
...
\1displayStatus
 ...
 /**
\1low temperature4，low temperature，dismissCameraLoading，
\14
 */
 if (!isTempShowDialog) {
 ...
 */
 ...
 temperatureSeekbar.setRangeAndPro(editMinValue, editMaxValue, realLeftValue, realRightValue) // 
 }
...
\1//configuration
 ...
 if (it == CameraItemBean.TYPE_TMP_H && SharedManager.isTipHighTemp) { // Temp
 val message =
 ...
 /**
\1low temperaturegain
\1@param isLow true-low temperature(gain） false-high temperature(gain)
 */
 private fun switchTempGain(
 isLow: Boolean,
 isShowLoading: Boolean,
 ) {
 if ((gainSelChar == 1 && isLow) || (gainSelChar == 0 && !isLow)) { // Mode
 return
 }
 ...
 /**
\1AI-、high temperature、low temperature
 */
 ...
 */
 ...
 /**
\1 1 menu- .
\1@param actionCode: 0-/ 1- 2-menu 3- 4-
 */
...
\1temperature
 ...
 if (!spaceChart.isVisible) { // Current，
...
\1(pseudo-color,set)
 */
 imageThread?.pseudocolorMode = pseudoColorMode // Settings
 ...
 */
 ...
 private var defaultIsPortrait = DeviceConfig.IS_PORTRAIT // Default
...
\1watermarkmenu 2D 
 ...
 ObserveBean.TYPE_TMP_H_S -> { // Temp
 switchTempSource(ObserveBean.TYPE_TMP_H_S)
 }

 ObserveBean.TYPE_TMP_L_S -> { // Temp
 ...
 */
 ...
 private val temperatureBytes = ByteArray(imageWidth * imageHeight * 2) // Temperature
...
\1renderingdisplay
 ...
 temperatureView.temperatureRegionMode = REGION_MODE_CENTER // Temp
 }, 1000)
 }
 }
 }
...
\1framedata
 this@IRThermalNightActivity.runOnUiThread {
\1，low temperature，dismissCameraLoading
\1Start，dismiss，dialog
 if (isOnRestart) {
 dismissCameraLoading()
 isOnRestart = false
 }
...
\1ts001
 ...
 /**
\1IRModeconfigurationinitialize
 */
...
// }
 ...
 /**
\1disabledrendering，Currentpseudo-colorTyperendering.
 */
...
\1// gettemperaturedata，，temperatureValue，bitmap
...
\1watermark
 ...
 if (curChooseTabPos == 1) { // TempModeSaveTemperature
 val capital =
 FrameStruct.toCode(
 name = getProductName(),
 ...
 */
 ...
 /**
\1display() set PopupWindow
 */
 private fun showSharpnessPopup() {
 // thermalRecyclerNight.setSettingSelected - synthetic method removed

 val maxSharpness = 4 // Value [0, 4]，
 val seekBarPopup = SeekBarPopup(this)
...
\1//IMAGE_PROP_LEVEL_SNR (0~3) (Default2) 
\1//IMAGE_PROP_LEVEL_TNR (0~3) (Default2) 

 /**
\1gain
\1IMAGE_PROP_MODE_AGC: Default2
\1IMAGE_PROP_ONOFF_AGC: Default1
 */
 open fun autoConfig() {
 lifecycleScope.launch(Dispatchers.IO) {
 iruvc?.let {
...
\1
 ircmd?.setContrast(saveSetBean.contrastValue)
 if (SaveSettingUtil.isSaveSetting) {
 XLog.i("ConfigurationMode：${if (SaveSettingUtil.isMeasureTempMode) "Temp" else ""}Mode")
 if (isTS001)
 {
 ...
 */
 ...
 XLog.i("TemperatureFailed: ${e.message}")
 }
 return tmp
 }
