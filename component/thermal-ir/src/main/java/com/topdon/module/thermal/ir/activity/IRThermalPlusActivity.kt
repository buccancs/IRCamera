...
class IRThermalPlusActivity : BaseIRPlushActivity() {
 ...
 super.initView()
\1findViewById<TextView>(R.id.toolbar_title)?.text = "device"
 ...
 SaveSettingUtil.FusionTypeLPYFusion -> { // 1
 thermalRecyclerNight?.twoLightType = TwoLightType.TWO_LIGHT_1
 }
 SaveSettingUtil.FusionTypeMeanFusion -> { // 2
 ...
 /**
\1.
\1@param action -1 1- 0
\1@param data CurrentValue
 */
 private fun setDisp(
 action: Int,
 data: Int,
...
\1rotation
 ...
 {
\1grayscalepseudo-colorfusionprocessing
...
\1temperature，imagerotation，raw data，（256*192）
 val tempData =
