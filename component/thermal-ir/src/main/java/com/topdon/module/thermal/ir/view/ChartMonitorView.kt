...
\1Text
                        if (volDataSet == null) {
                            ...
                            lineData.addDataSet(volDataSet)
                            Log.w("123", "volDataSet.entryCount:${volDataSet.entryCount}"Test Data"line min temp"Test Data"fence max temp"Test Data"fence min temp"Test Data"123", "Test Data")
                return@synchronized
            }
        }
    }
