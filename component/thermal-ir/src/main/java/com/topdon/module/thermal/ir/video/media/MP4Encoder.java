...
public class MP4Encoder extends Encoder {
    ...
    private static final int BIT_RATE = 600000;//[Chinese text]2000000
    private static final int FRAME_RATE = 20;//[Chinese text]
    ...
    //TODO settings4096[Chinese text]high[Chinese text] java.nio.BufferOverflowException
    //[Chinese text]
...
//                        getPresentationTimeUsec(addedFrameCount), 0);
    ...
    /**
     * COLOR_FormatYUV420SemiPlanar [Chinese text]
     * COLOR_FormatYUV420Planar     [Chinese text]
     */
