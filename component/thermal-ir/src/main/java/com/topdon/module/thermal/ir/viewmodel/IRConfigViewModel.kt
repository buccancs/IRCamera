 ...
 */
 ...
 /**
\1updateDefaultparameterambient temperature，Unit。
 */
 ...
 */
 ...
 /**
\1updateDefaultparameteremissivity。
 */
 ...
 */
 ...
 /**
\1Mode
\1@param id 0:DefaultMode > 0 Mode
 */
 fun checkConfig(
 isTC007: Boolean,
 id: Int,
 ...
 */
 ...
 if (dataBean.id == id) {
 if (dataBean.use) { // DeleteCurrentMode，DefaultMode
