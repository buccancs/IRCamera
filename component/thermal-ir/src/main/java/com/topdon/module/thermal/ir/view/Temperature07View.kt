...
/**
 * TC007 [Chinese text], [Chinese text]temperature, only[Chinese text]operationpointline[Chinese text] View.
 *
...
class Temperature07View : TemperatureBaseView {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when (mode) {
            ...
            Mode.TREND -> {
                //[Chinese text] TC007 [Chinese text], [Chinese text] TC007 [Chinese text]
            }
            else -> {
