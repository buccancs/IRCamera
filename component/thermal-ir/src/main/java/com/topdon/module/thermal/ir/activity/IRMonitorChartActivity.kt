...
\1Textconfiguration,pseudo-colorText
                try {
                    if (!isStop)
                        {
                            pseudoColorMode = 3
    ...
    override fun onResume() {
        ...
        mpChartView.highlightValue(null) // Marker
    }
            ...
            IRUVCTC(
                ...
                object : ConnectCallback {
                    ...
                    override fun onIRCMDCreate(ircmd: IRCMD) {
                        ...
                        Log.d(TAG, "TPD_PROP_GAIN_SEL="Test Data"TextTPD_PROP DISTANCE:$disChar, EMS:$emsChar}"Test Data"Text: ${e.message}"Test Data"temp correct, oldTemp = " + paramsArray[0] + " ems = " + paramsArray[1] + " ta = " + paramsArray[2] + " " +
