...
class IRMonitorChartActivity : BaseActivity(),ITsTempListener {
    ...
    /**
     * [Chinese text], [Chinese text]in progress[Chinese text] point/line/[Chinese text] message.
     */
    ...
    override fun onResume() {
        ...
        mpChartView.highlightValue(null) // [Chinese text]high[Chinese text]pointMarker
    }
