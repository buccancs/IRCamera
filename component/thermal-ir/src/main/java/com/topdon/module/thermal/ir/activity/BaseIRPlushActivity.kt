...
abstract class BaseIRPlushActivity : IRThermalNightActivity(), OnUSBConnectListener, IIRFrameCallback {
    ...
    private var imageWidth = 0 // [Chinese text]
    private var imageHeight = 0 // [Chinese text]high[Chinese text]
    ...
    override fun initView() {
        super.initView()
        if (isDualIR()){
            // defaultDataFlowMode [Chinese text] [Chinese text]+temperature, [Chinese text] SDK [Chinese text] 256x384
            // [Chinese text], [Chinese text]temperature[Chinese text] 256x(384/2) = 256x192
            // [Chinese text], [Chinese text] 192x256
            imageWidth = 192
            imageHeight = 256
...
//        dualView!!.startPreview()
    ...
    private fun initPseudoColor() {
        ...
        try {
            // [Chinese text]Pseudo color, [Chinese text]Pseudo color, [Chinese text]sdk[Chinese text]
