...
class DistanceMeasureView : View {
    ...
    private fun init() {
        ...
        // settings[Chinese text]line[Chinese text]line[Chinese text]
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        // [Chinese text], [Chinese text]line[Chinese text]in progress, [Chinese text]20dp
        val screenHeight = measuredHeight
        val lineHeight = 50 // [Chinese text]dimens.xmlin progress[Chinese text]line_height
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.action) {
            MotionEvent.ACTION_DOWN, MotionEvent.ACTION_MOVE -> {
                ...
                // [Chinese text]line[Chinese text]range, [Chinese text]line[Chinese text]range
                if (newY < 0) {
                    newY = 0f
                } else if (newY > height) {
                    newY = height.toFloat()
