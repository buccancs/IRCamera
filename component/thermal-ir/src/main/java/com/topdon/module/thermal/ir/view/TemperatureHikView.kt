...
未rotation前的temperaturearray.
    ...
    @SuppressLint("DrawAllocation")
        ...
        // Due to legacy issues, 2D editing and thermal imaging centerpoint logic are inconsistent
        // 2D editing centerpoint follows full imageset, opens/closes with full image;
        // thermal imaging centerpoint is enabled when full image or there are points/lines/areas
        // Product hasn't clearly defined centerpoint logic, following thermal imaging approach here
        // centerpoint
        ...
        // Full image minimum and maximum temperature
        // if (isShowFull) {
        // tempInfo.full?.let {
...
执行temperaturecalculation的line程.
     */
        ...
        // trendResult = libIRTemp.getTemperatureOfLine(Line(startPoint, endPoint))
                        ...
                        // When View size changes, xScale and yScale change, but existing drawing coordinates remain unchanged
                        // Using old coordinates with new scale to calculate temperature coordinates may exceed range and throw exception
                    }
