 ...
 *
\1
\1- Whether TC007: [ExtraKeyConfig.IS_TC007] （ambient temperature、emissivity）
\1- Current: [ExtraKeyConfig.FILE_ABSOLUTE_PATH] （interface，）
\1- Currentfull imagetemperaturedata: [ExtraKeyConfig.IMAGE_TEMP_BEAN] （interface，）
 */
...
etReportAuthor.isVisible = isChecked
 ...
 var environment = 30f // Temperature
 var distance = 0.25f // 
 var radiation = 0.95f // 
