...
class IRConfigActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (v) {
            ivDefaultSelector -> {// [Chinese text]mode-[Chinese text]in progress
                viewModel.checkConfig(isTC007, 0)
            }
            viewDefaultTempBg -> {// [Chinese text]mode-[Chinese text]temperature
            ...
            viewDefaultDisBg -> {// [Chinese text]mode-[Chinese text]
            ...
            tvDefaultEmValue -> {// [Chinese text]mode-[Chinese text]
