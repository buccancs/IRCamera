 ...
 */
 ...
 @Volatile
 private var temperatureBytes = ByteArray(imageWidth * imageHeight * 2) // Temperature
...
\1high/low gain 1:gain 0: gain
 ...
 var isOpenPreview = false // Status
 ...
 */
 ...
 binding.thermalRecyclerNight.isVideoMode = SaveSettingUtil.isVideoMode // /Status
 binding.thermalRecyclerNight.fenceSelectType = FenceType.FULL // 
 binding.thermalRecyclerNight.isUnitF = SharedManager.getTemperature() == 0 // TemperatureUnit
 binding.thermalRecyclerNight.setTempLevel(temperatureMode) // CurrentTemperature
...
\1renderingdisplay
 ...
 delay(1000)
 binding.temperatureView?.temperatureRegionMode = REGION_MODE_CENTER // Temp
 }
 }
 }
 }
...
\1 - disabled due to missing layout
...
\1getgainStatus PASS
 ...
 XLog.e("$TAG--Temperature：${e.message}")
 } finally {
 return tempNew ?: 0f
 }
 }
