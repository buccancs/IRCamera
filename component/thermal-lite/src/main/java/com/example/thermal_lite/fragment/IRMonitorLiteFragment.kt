...
class IRMonitorLiteFragment : BaseFragment(), ITsTempListener {
 ...
 protected var temperatureBytes = ByteArray(192 * 256 * 2) // Temperature
 var rotateAngle = 270
...
\1gainModeinitialize
 delay(2000) // sdk2SettingsSuccess
...
\1renderingdisplay
 ...
 temperatureView.temperatureRegionMode = TemperatureView.REGION_MODE_CLEAN // Temp
 }
 }
 }
 }
