 ...
 * [Chinese text], [Chinese text]APP[Chinese text]
 */
public class DeviceIrcmdControlManager {
    ...
    public void setSendFPGACommand(boolean sendFPGACommand) {
        ...
        /**
     * [Chinese text]fpga[Chinese text]
     */
...
//                        }
                        ...
                        if (mIrcmdEngine != null) {
                            ...
                            // [Chinese text]FPGA[Chinese text] PASS
...
//                    }
    ...
    public static byte[] intToBytes2(long value) {
        ...
        /**
     * [Chinese text]mode[Chinese text]
     * byte[Chinese text]in progress[Chinese text]int[Chinese text], [Chinese text]for(low[Chinese text], high[Chinese text])[Chinese text]. [Chinese text]intToBytes2()[Chinese text]
     */
    ...
    public static String getReadValue(String name, byte[] ispParamReadByteArray, int byteWidth, int begin, int end) {
        ...
        /**
     * int[Chinese text]byte[Chinese text], [Chinese text], [Chinese text], [Chinese text]
     *
     * @param name
     * @param ispParamReadByteArray
     * @param byteWidth
    ...
    public static long byteArrToBinStr(String name, byte[] ispParamReadByteArray, int byteWidth, int begin, int end,
        ...
        // [Chinese text], [Chinese text]int[Chinese text], [Chinese text]  0000000000000001 00000000 10001001
        ...
        // [Chinese text]begin[Chinese text]end[Chinese text],[Chinese text]
        ...
        /**
     * SettingsISP[Chinese text]
     * [Chinese text]sendISPParam[Chinese text]Settings[Chinese text]
     *
     * @param param_path
     */
     ...
     * [Chinese text]sendISPParam[Chinese text]Settings[Chinese text]
     * <p>
     * ISP[Chinese text]Settings[Chinese text], [Chinese text], [Chinese text]
     *
