...
public class DefRangeSeekBar extends View {
    ...
    // Additional methods required by thermal-ir component that don't exist
    
    /**
     * Set range and progress values
     */
    public void setRangeAndPro(float minValue, float maxValue, float leftValue, float rightValue) {
        // Stub implementation - set the range and progress
    }
    
    /**
     * Draw indication path
     */
    public void drawIndPath(boolean enabled) {
        // Stub implementation
    }
    
    /**
     * Set color list for gradient
     */
    ...
    /**
     * Set pseudo code for temperature mode
     */
