...
public class IRUVCTC {
    ...
    public IRUVCTC(int cameraWidth, int cameraHeight, Context context, SynchronizedBitmap syncimage,
        ...
        int low_gain_over_temp_data = (int) ((550 + 273.15) * 16 * 4); //(550°C)
        int high_gain_over_temp_data = (int) ((100 + 273.15) * 16 * 4); //(100°C)
    ...
    public void init(int cameraWidth, int cameraHeight) {
        Log.w(TAG, "init");
        // UVCCamera init
         * cameraWidth:256,cameraHeight:384,+
